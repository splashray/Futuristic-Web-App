                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <span class="text-c-blue f-w-600">Gallery</span>
                                                  
                                                        <div>  <a href="gallery.php">
                                                            <span class="f-left m-t-10 text-muted">
                                                                <i class="text-c-blue f-16 icofont icofont-warning m-r-10"></i>Click here to check
                                                            </span> </a>
                                                        </div>
                                                    </div>
                                                </div>
         ...
         <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <span class="text-c-green f-w-600">Messages</span>
                                                      
                                                        <div><a href="messages.php">
                                                            <span class="f-left m-t-10 text-muted">
                                                                <i class="text-c-green f-16 icofont icofont-tag m-r-10"></i>Click here to check
                                                            </span> </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <span class="text-c-pink f-w-600">Setting</span>
                                                        <div>  <a href="admin-account-setting.php">
                                                            <span class="f-left m-t-10 text-muted">
                                                                <i class="text-c-pink f-16 icofont icofont-calendar m-r-10"></i>Click here to check
                                                            </span> </a>
                                                        </div>
                                                    </div>
                                                </div>
