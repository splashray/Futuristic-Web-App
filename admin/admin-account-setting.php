  ...
  ob_end_flush();
    ...
    if(isset($_POST['create'])){
        ...
        if($password=="" || $username ==""){
            echo "<script type='text/javascript'> document.location = 'admin-account-setting.php'; </script>";
        }else{
                ...
                $create_query = mysqli_query($con, $query);
                        ...
                        $extra="admin-account-setting.php";
        ...
        if(isset($_POST['change-password'])) {
            ...
            $num=mysqli_fetch_array($sql);
                ...
                {
                $userid=$_SESSION['id'];
                $ret=mysqli_query($con,"update admin set password='$newpassword' where id='$userid'");
